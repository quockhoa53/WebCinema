...
public class CustomerController {
	...
	public String payment(ModelMap model,@PathVariable("maSC") Integer maSC) {
		doDL(model);
		LichChieu lc = layLC(maSC);
	...
	public String payment2(ModelMap model,@PathVariable("maSC") Integer maSC, @PathVariable("soGhe") Integer soGhe) {
		...
		catch(Exception e)
		{
			...
			return "redirect: DoAnWebCinema/customer/payment_1/{maSC}/{soGhe}.htm";
		}
		finally {
			session.close();
		}
