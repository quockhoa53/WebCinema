...
<body class="page">
		...
		<div class="form-tt" >
			  <!--    <i class="fa-solid fa-xmark iconclose"></i> -->
                ...
                <form action="http://localhost:8080/DoAnWebCinema/login/login.htm" method="post" name="dang-nhap">
                <p
                ...
                <a href="http://localhost:8080/DoAnWebCinema/register.htm" style="color: red;">Đăng ký</a>
                </label>
                </form>	
		</div>
