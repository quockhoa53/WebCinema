...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:8080/DoAnWebCinema/fonts/fontawesome-pro-6.1.1-web/css/all.min.css" />
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.8.2/css/all.min.css" integrity="sha512-rqQltXRuHxtPWhktpAZxLHUVJ3Eombn3hvk9PHjV/N5DMUYnzKPC1i3ub0mEXgFzsaZNeJcoE0YHq0j/GFsdGg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <!-- Template CSS -->
	<link rel="stylesheet" href="http://localhost:8080/DoAnWebCinema/css/main.css" />
    <link rel="stylesheet" href="http://localhost:8080/DoAnWebCinema/css/alertify.min.css" />
    <link rel="stylesheet" href="http://localhost:8080/DoAnWebCinema/css/account.css">
   	<link href="http://localhost:8080/DoAnWebCinema/css/font-awesome.min.css" rel="stylesheet" >
	<link href="http://localhost:8080/DoAnWebCinema/css/global.css" rel="stylesheet">
	<link href="http://localhost:8080/DoAnWebCinema/css/index.css" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css2?family=Rajdhani&display=swap" rel="stylesheet">
	<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.7.1/font/bootstrap-icons.css">
	<script src="http://localhost:8080/DoAnWebCinema/js/bootstrap.bundle.min.js"></script>
...
<div class="container">
 <div class="row top_1">
    ...
    <p><a href="customer/account"><strong>${user.tenKH}</strong></a></p>
    </div>
</div>
 </div>
</div>
...
<div  class="alert-flag "  aType='${message.type}'
                        ...
                        <div class="order_review border-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="image product-thumbnail">
                                                <img src="${s.dsLichChieu.dsPhim.linkAnh }"
                                                    alt="#" />
                                            </td>
                                            <td>
                                                <h5>
                            ...
                            <div class="payment_method">
                                <div class="mb-25">
                                    <h5>
                                        Địa Chỉ Rạp Chiếu:
                                        <span class="text-brand">Tứ Trụ Cinema</span>
                                    </h5>
                                </div>
                            </div>
                            <div class="bt-1 border-color-1 mt-30 mb-30"></div>
    ...
    <script src=""></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/vendor/modernizr-3.6.0.min.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/vendor/jquery-3.6.0.min.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/vendor/jquery-migrate-3.3.0.min.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/vendor/bootstrap.bundle.min.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/slick.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/jquery.syotimer.min.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/wow.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/jquery-ui.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/perfect-scrollbar.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/magnific-popup.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/select2.min.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/waypoints.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/counterup.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/jquery.countdown.min.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/images-loaded.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/isotope.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/scrollup.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/jquery.vticker-min.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/jquery.theia.sticky.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/plugins/jquery.elevatezoom.js"></script>
    <!-- Template  JS -->
    <script src="http://localhost:8080/DoAnWebCinema/js/account.js"></script>


    <script src="http://localhost:8080/DoAnWebCinema/js/shop.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/inputNumber.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/quickView.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/alertify.min.js"></script>
    <script src="http://localhost:8080/DoAnWebCinema/js/showMessage.js"></script>
	<script src="http://localhost:8080/DoAnWebCinema/js/alertify.min.js"></script>
