...
<link rel="icon" type="image/png" sizes="16x16"
	href="http://localhost:8080/DoAnWebCinema/imgs/favicon.png">
<!-- Custom CSS -->
<link
...
<div class="alert-flag" aType='${message.type}'
						...
						<div class="row">
							...
							<div class="tm-bg-primary-dark tm-block tm-block-h-auto">
								<div class="row tm-edit-product-row">
									...
									<form class="contener1-fix"
										action="/DoAnWebCinema/admin/showtimes/update/${l.maSC}.htm"
	...
	<script
		src="http://localhost:8080/DoAnWebCinema/js/chartist-plugin-tooltip.min.js"></script>
	<script
		src="http://localhost:8080/DoAnWebCinema/js/dashboard1.js"></script>
