...
<link
	href="http://localhost:8080/DoAnWebCinema/css/chartist.min.css"
	rel="stylesheet">
<link rel="stylesheet"
	href="http://localhost:8080/DoAnWebCinema/css/chartist-plugin-tooltip.css">
<link rel="stylesheet"
...
<!-- Custom CSS -->
<link
	href="http://localhost:8080/DoAnWebCinema/css/style.min.css"
	rel="stylesheet">
<link
	href="http://localhost:8080/DoAnWebCinema/css/employee.css"
	rel="stylesheet">
<link rel="stylesheet"
	href="http://localhost:8080/DoAnWebCinema/css/detail-test.css">
<link rel="stylesheet"
	href="http://localhost:8080/DoAnWebCinema/css/fix-test.css">
<link rel="stylesheet"
	href="http://localhost:8080/DoAnWebCinema/css/add-test.css">
...
<h2> Bootstrap Sort Table </h2> -->
												...
												<div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                                                    ...
                                                    <!-- <h3 class="header-name-info">Thông Tin Nhân Viên</h3> 
														...
														<form class="contener1-add"
															action="/DoAnWebCinema/admin/movie/add.htm"
																...
																<div class="body-add">
																	...
																	<div class="body-left-add">
																		...
																		<div class="detail-info-add">
																			...
																			<input class="detail-info-buton-add" name="linkAnh"
																				required />
																		</div>
																		<div class="detail-info-add">
																		...
																		<div class="same-add">
																			<div class="detail-info-left">
																				...
																				<form class="input-date">
																					<input type="date" name="ngayKhoiChieu" id=""
											...
											<form class="container-info" style="height: 100%;">
												<div class="body">
													<div class="body-right">
														<div class="photo">
															<img src="${p.linkAnh }" style="height: 240px;" />
														</div>
													...
													<div class="body-left">
														...
														<div class="same">
															<div class="detail-info">
																...
																<h6 class="detail-info-buton">${p.ngayKhoiChieu }</h6>
															</div>
															<div class="detail-info">
						...
						<div class="row">
							...
							<div class="tm-bg-primary-dark tm-block tm-block-h-auto">
								<div class="row tm-edit-product-row">
									...
									<form class="contener1-add"
										action="/DoAnWebCinema/admin/movie/update/${p.maPhim}.htm"
												...
												<div class="body-left-add">
													...
													<div class="same-add">
														<div class="detail-info-left">
															...
															<form class="input-date">
																<input type="date" name="ngayKhoiChieu" id=""
																	class="input-name-add" value="${p.ngayKhoiChieu }" required />
															</form>
														</div>
													</div>
												</div>
	...
	<script
		src="http://localhost:8080/DoAnWebCinema/js/jquery.min.js"></script>
	<!-- Bootstrap tether Core JavaScript -->
	<script
		src="http://localhost:8080/DoAnWebCinema/js/bootstrap.bundle.min.js"></script>
	<script
		src="http://localhost:8080/DoAnWebCinema/js/app-style-switcher.js"></script>
	<script
		src="http://localhost:8080/DoAnWebCinema/js/jquery.sparkline.min.js"></script>
	<!--Wave Effects -->
	<script
		src="http://localhost:8080/DoAnWebCinema/js/waves.js"></script>
	<!--Menu sidebar -->
	<script
		src="http://localhost:8080/DoAnWebCinema/js/sidebarmenu.js"></script>
	<!--Custom JavaScript -->
	<script
		src="http://localhost:8080/DoAnWebCinema/js/custom.js"></script>
	<!--This page JavaScript -->
	<!--chartis chart-->
	<script
		src="http://localhost:8080/DoAnWebCinema/js/chartist.min.js"></script>
	<script
		src="http://localhost:8080/DoAnWebCinema/jschartist-plugin-tooltip.min.js"></script>
	<script
		src="http://localhost:8080/DoAnWebCinema/js/pages/dashboards/dashboard1.js"></script>
