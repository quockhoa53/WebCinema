...
<!-- Bootstrap core CSS -->
	...
	<link rel="stylesheet" href="http://localhost:8080/DoAnWebCinema/css/register.css"/>

<style>

.page {
	background-image: url("https://assets.nflxext.com/ffe/siteui/vlv3/5523db5a-e2b2-497f-a88b-61f175c3dbad/924da883-2be9-48cc-84cc-45dbf5c7d2da/VN-vi-20230306-popsignu...ge.jpg");
...
<select name="year" id="year" class="select-date" required>
			...
			<a href="http://localhost:8080/DoAnWebCinema/login.htm" class="sign-up-link">Đăng nhập</a>
			</div>
		</div>
	</div>
